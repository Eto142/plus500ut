window.addEventListener("load",()=>{gsap.config({nullTargetWarn:!1});let e=e=>{e.forEach(e=>{let t=e.querySelectorAll(".item-icon"),r=gsap.timeline().from(t,{opacity:0,scale:0,duration:.5,stagger:.1});ScrollTrigger.create({trigger:e,start:"-500 50%",end:"0 50%",animation:r})})};ScrollTrigger.saveStyles(".plus-bg, .item-icon"),ScrollTrigger.matchMedia({"(min-width: 769px)":function(){let t=document.querySelectorAll(".gs-anim-target");t.forEach(e=>{let t=e.querySelectorAll(".plus-bg:not(.gs-not-animation)"),r=gsap.timeline().from(t,{yPercent:150,duration:1,stagger:.1,ease:"slow"});ScrollTrigger.create({trigger:e,start:"0 50%",end:"100% 50%",animation:r,scrub:1})});let r=document.querySelectorAll(".items-icon-group");e(r)},"(max-width: 768px)":function(){let t=document.querySelectorAll(".item-box");e(t)},all:function(){}})});
